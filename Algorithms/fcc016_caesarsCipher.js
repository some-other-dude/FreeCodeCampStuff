...
function rot13(str) { // LBH QVQ VG!
    ...
    function decode13(rotStr) {
        var code = rotStr.charCodeAt();
        if (64 < code && code < 78) {
            code += 13;
        } else if (77 < code && code < 91) {
            code -= 13;
        }
        return  String.fromCharCode(code);
    }
    clearText = str.split("").map(function(c){return decode13(c);}).join("");
    return clearText;
}
